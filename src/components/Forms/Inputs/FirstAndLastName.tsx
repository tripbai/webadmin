      ...
      <div className="flex align-center">
        <div className="w-half mr-1">
          ...
          <input
            type="text"
            placeholder="John"
            className={`w-full pr-12 pl-3 py-2 text-gray-500 bg-transparent outline-none border focus:border-indigo-600 shadow-sm rounded-lg ${getInputStateBasedClass()}`}
